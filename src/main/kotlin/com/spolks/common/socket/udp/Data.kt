 ...
 * After [UDPSocket.bind] call it becomes [BOUND].
 * After [UDPSocket.close] call in becomes [CLOSED].
 *
 * Socket state change is a [synchronized] operation.
 * When state is [UNBOUND], you can only [UDPSocket.bind].
 * When state is [BOUND], you can [UDPSocket.runOnce], [UDPSocket.send], [UDPSocket.receive] and [UDPSocket.close].
...
typealias PacketAndContinuation = Pair<QueuedDatagramPacket, CancellableContinuation<UDPSendContext>>